...
public class VerificationActivity2 extends AppCompatActivity {
    ...
    private EditText codeText2;
    private Button verifyButton2;
    private Button sendButton2;
    private Button resendButton2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        codeText2 = (EditText) findViewById(R.id.codeText2);
        verifyButton2 = (Button) findViewById(R.id.verifyButton2);
        sendButton2 = (Button) findViewById(R.id.sendButton2);
        resendButton2 = (Button) findViewById(R.id.resendButton2);
        signoutButton2 = (Button) findViewById(R.id.signoutButton2);
        statusText2 = (TextView) findViewById(R.id.statusText2);

        ccp= (CountryCodePicker) findViewById(R.id.ccp);
        ccp.registerCarrierNumberEditText(phoneText2);

        verifyButton2.setEnabled(false);
        resendButton2.setEnabled(false);
        signoutButton2.setEnabled(false);
        statusText2.setText("Signed Out");
        ...
        verificationCallbacks =
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationCompleted(
                        ...
                        signoutButton2.setEnabled(true);
                        statusText2.setText("Signed In");
                        resendButton2.setEnabled(false);
                        verifyButton2.setEnabled(false);
                        codeText2.setText("");
    ...
    public void verifyCode(View view) {
        ...
        String code = codeText2.getText().toString();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerificationActivity2.this, DoctorLogin.class);
